...
use Zionon\MultiAuth\PasswordResets\DatabaseTokenRepository as DbRepository;
use Zionon\MultiAuth\Console\PasswordResetsTableCommand;
use Zionon\MultiAuth\Console\ClearResetsTableCommand;
